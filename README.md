...
Inspired by the lists [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,143 | 🐛 105 | 📅 2026-08-21, [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,625 | 🐛 61 | 🌐 Ruby | 📅 2024-06-02, and [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,623 | 🐛 26 | 📅 2026-05-03.
...
* [GopherLua](https://github.com/yuin/gopher-lua) ⭐ 6,974 | 🐛 103 | 🌐 Go | 📅 2026-04-01 - Lua 5.1 VM and compiler implemented in Go with Go APIs.
...
* [MoonSharp](https://github.com/xanathar/moonsharp) ⭐ 1,614 | 🐛 111 | 🌐 C# | 📅 2026-08-04 - A Lua interpreter written entirely in C# for the .NET, Mono and Unity platforms.
...
* [Lua](http://www.lua.org/download.html) - Lua's original ANSI C interpreter.
  * [Lua Repo](https://github.com/lua/lua) ⭐ 10,255 | 🐛 0 | 🌐 C | 📅 2026-08-07 - The official Lua repo, as seen by the Lua team, mirrored to GitHub.
...
* [vscode-lua](https://github.com/trixnz/vscode-lua) ⭐ 124 | 🐛 60 | 🌐 TypeScript | 📅 2024-03-21 - VSCode intellisense and linting.
...
* [Lua Fun](https://github.com/luafun/luafun) ⭐ 2,261 | 🐛 46 | 🌐 Lua | 📅 2025-04-15 - High-performance functional programming library designed for LuaJIT.
* [Penlight](https://github.com/stevedonovan/Penlight) ⭐ 2,125 | 🐛 44 | 🌐 Lua | 📅 2026-08-15 - Broad, heavyweight utility library, inspired by Python's standard libs. Provides the batteries that Lua doesn't.
...
* [lume](https://github.com/rxi/lume/) ⭐ 1,240 | 🐛 22 | 🌐 Lua | 📅 2023-11-19 - Utility belt library geared toward game development.
...
* LÖVE
  * [awesome-love2d](https://github.com/love2d-community/awesome-love2d) ⭐ 4,479 | 🐛 0 | 🌐 PowerShell | 📅 2026-08-23 - A list like this one, but focused on game dev and the LÖVE platform.
...
* Collision detection
  * [bump.lua](https://github.com/kikito/bump.lua) ⭐ 1,099 | 🐛 13 | 🌐 Lua | 📅 2023-09-29 - Minimal rectangle-based collision detection which handles tunnelling and basic collision resolution.
...
* Examples
  ...
  * [Mari0](https://github.com/Stabyourself/mari0) ⭐ 770 | 🐛 13 | 🌐 Lua | 📅 2023-09-15 - Fusion of Mario and Portal, made with LÖVE. See also its [wikipedia entry](https://en.wikipedia.org/wiki/Mari0).
...
* [Pegasus.lua](https://github.com/EvandroLG/pegasus.lua) ⭐ 466 | 🐛 16 | 🌐 Lua | 📅 2026-03-08 - Pegasus.lua is a http server to work with web applications written in Lua language.
...
* Third-party modules
  * [lua-resty-http](https://github.com/pintsized/lua-resty-http) ⭐ 2,078 | 🐛 42 | 🌐 Lua | 📅 2026-08-11 - Lua HTTP client driver, built on the cosocket API.
* Frameworks & tools
  * [Kong](https://github.com/Kong/kong) ⭐ 44,043 | 🐛 191 | 🌐 Lua | 📅 2026-08-16 - Microservice & API Management Layer.
...
* [middleclass](https://github.com/kikito/middleclass) ⭐ 1,919 | 🐛 1 | 🌐 Lua | 📅 2025-11-03 - Simple but robust OOP library with inheritance, methods, metamethods, class variables and mixins.
...
* [luaposix](https://github.com/luaposix/luaposix) ⭐ 591 | 🐛 34 | 🌐 C | 📅 2026-07-20 - Bindings for POSIX APIs, including curses.
...
* [LuaDate](https://github.com/Tieske/date) ⭐ 275 | 🐛 1 | 🌐 Lua | 📅 2026-02-17 - Date and time module with parsing, formatting, addition/subtraction, localization, and ISO 8601 support.
...
* JSON
  * [json.lua](https://github.com/rxi/json.lua) ⭐ 2,186 | 🐛 28 | 🌐 Lua | 📅 2023-11-28 - A fast and tiny JSON library in pure Lua.
...
* XML
  * [SLAXML](https://github.com/Phrogz/SLAXML) ⭐ 165 | 🐛 7 | 🌐 Lua | 📅 2024-07-12 - Pure Lua SAX-like streaming XML parser.
  * [LuaExpat](https://matthewwild.co.uk/projects/luaexpat/) - SAX XML parser via binding to the Expat library.
* MessagePack
  * [lua-cmsgpack](https://github.com/antirez/lua-cmsgpack) ⭐ 384 | 🐛 33 | 🌐 C | 📅 2021-12-28 - A MessagePack C implementation with Lua bindings, as used by Redis.=
  * [lua-MessagePack](https://github.com/fperrad/lua-MessagePack) - Pure Lua implementation of MessagePack.
* LPeg
  * [LuLPeg](https://github.com/pygy/LuLPeg) ⭐ 272 | 🐛 12 | 🌐 Lua | 📅 2022-04-07 - A pure Lua implementation of LPeg v0.12.
...
* [LuaSocket](https://github.com/diegonehab/luasocket) ⭐ 2,020 | 🐛 106 | 🌐 HTML | 📅 2026-08-17 - Networking extension which provides a socket API for TCP and UDP, and implements HTTP, FTP, and SMTP.
...
* [pgmoon](https://github.com/leafo/pgmoon) ⭐ 433 | 🐛 22 | 🌐 MoonScript | 📅 2026-08-11 - Lua PostgreSQL driver for OpenResty, LuaSocket, and cqueues.
...
* [luassert](https://github.com/Olivine-Labs/luassert) ⭐ 250 | 🐛 11 | 🌐 Lua | 📅 2026-08-15 - Assertion library extending Lua's built-in assertions.
...
* [luvit](https://github.com/luvit/luvit) ⭐ 3,963 | 🐛 95 | 🌐 Lua | 📅 2026-04-02 - Node.js's underlying architecture (libUV) with Lua on top instead of JavaScript.
...
* [KoReader](https://github.com/koreader/koreader) ⭐ 29,280 | 🐛 1,328 | 🌐 Lua | 📅 2026-08-26 - An ebook reader application supports PDF, DJVU, EPUB, FB2 and much more, running on Kindle, Kobo, PocketBook and Android devices.
