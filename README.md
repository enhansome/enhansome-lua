...
Inspired by the lists [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,391 | 🐛 106 | 📅 2026-09-02, [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,666 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02, and [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,787 | 🐛 25 | 📅 2026-09-02.
...
* [lupa](https://github.com/scoder/lupa) ⭐ 1,150 | 🐛 63 | 🌐 Python | 📅 2026-09-11 - Python bindings to LuaJIT2.
...
* [Lua](http://www.lua.org/download.html) - Lua's original ANSI C interpreter.
  * [Lua Repo](https://github.com/lua/lua) ⭐ 10,295 | 🐛 0 | 🌐 C | 📅 2026-08-28 - The official Lua repo, as seen by the Lua team, mirrored to GitHub.
...
* Examples
  ...
  * [Mari0](https://github.com/Stabyourself/mari0) ⭐ 773 | 🐛 13 | 🌐 Lua | 📅 2023-09-15 - Fusion of Mario and Portal, made with LÖVE. See also its [wikipedia entry](https://en.wikipedia.org/wiki/Mari0).
...
* [awesome-resty](https://github.com/bungle/awesome-resty) ⭐ 2,487 | 🐛 2 | 📅 2026-05-26 - A list like this one, but focused on OpenResty.
* Core platform
...
* Frameworks & tools
  * [Kong](https://github.com/Kong/kong) ⭐ 44,124 | 🐛 199 | 🌐 Lua | 📅 2026-09-07 - Microservice & API Management Layer.
...
* JSON
  * [json.lua](https://github.com/rxi/json.lua) ⭐ 2,189 | 🐛 28 | 🌐 Lua | 📅 2023-11-28 - A fast and tiny JSON library in pure Lua.
...
* [KoReader](https://github.com/koreader/koreader) ⭐ 29,661 | 🐛 1,342 | 🌐 Lua | 📅 2026-09-12 - An ebook reader application supports PDF, DJVU, EPUB, FB2 and much more, running on Kindle, Kobo, PocketBook and Android devices.
