...
Inspired by the lists [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,394 | 🐛 105 | 📅 2026-08-21, [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,637 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02, and [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,661 | 🐛 26 | 📅 2026-05-03.
...
* [GopherLua](https://github.com/yuin/gopher-lua) ⭐ 6,975 | 🐛 103 | 🌐 Go | 📅 2026-04-01 - Lua 5.1 VM and compiler implemented in Go with Go APIs.
...
* [MoonSharp](https://github.com/xanathar/moonsharp) ⭐ 1,614 | 🐛 112 | 🌐 C# | 📅 2026-08-04 - A Lua interpreter written entirely in C# for the .NET, Mono and Unity platforms.
...
* [Lua](http://www.lua.org/download.html) - Lua's original ANSI C interpreter.
  * [Lua Repo](https://github.com/lua/lua) ⭐ 10,268 | 🐛 0 | 🌐 C | 📅 2026-08-28 - The official Lua repo, as seen by the Lua team, mirrored to GitHub.
...
* LÖVE
  * [awesome-love2d](https://github.com/love2d-community/awesome-love2d) ⭐ 4,481 | 🐛 0 | 🌐 PowerShell | 📅 2026-08-23 - A list like this one, but focused on game dev and the LÖVE platform.
...
* Examples
  ...
  * [Mari0](https://github.com/Stabyourself/mari0) ⭐ 771 | 🐛 13 | 🌐 Lua | 📅 2023-09-15 - Fusion of Mario and Portal, made with LÖVE. See also its [wikipedia entry](https://en.wikipedia.org/wiki/Mari0).
...
* Frameworks & tools
  * [Kong](https://github.com/Kong/kong) ⭐ 44,059 | 🐛 193 | 🌐 Lua | 📅 2026-08-16 - Microservice & API Management Layer.
...
* JSON
  * [json.lua](https://github.com/rxi/json.lua) ⭐ 2,185 | 🐛 28 | 🌐 Lua | 📅 2023-11-28 - A fast and tiny JSON library in pure Lua.
...
* [LuaSocket](https://github.com/diegonehab/luasocket) ⭐ 2,021 | 🐛 109 | 🌐 HTML | 📅 2026-08-30 - Networking extension which provides a socket API for TCP and UDP, and implements HTTP, FTP, and SMTP.
...
* [pgmoon](https://github.com/leafo/pgmoon) ⭐ 434 | 🐛 22 | 🌐 MoonScript | 📅 2026-08-11 - Lua PostgreSQL driver for OpenResty, LuaSocket, and cqueues.
...
* [luadec51](https://github.com/sztupy/luadec51) ⭐ 356 | 🐛 7 | 🌐 C | 📅 2022-03-14 - Lua Decompiler for Lua version 5.1.
...
* [KoReader](https://github.com/koreader/koreader) ⭐ 29,379 | 🐛 1,329 | 🌐 Lua | 📅 2026-08-30 - An ebook reader application supports PDF, DJVU, EPUB, FB2 and much more, running on Kindle, Kobo, PocketBook and Android devices.
