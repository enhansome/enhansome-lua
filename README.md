...
Inspired by the lists [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,813 | 🐛 106 | 📅 2026-09-02, [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,681 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02, and [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,855 | 🐛 25 | 📅 2026-09-02.
...
* [GopherLua](https://github.com/yuin/gopher-lua) ⭐ 6,978 | 🐛 104 | 🌐 Go | 📅 2026-04-01 - Lua 5.1 VM and compiler implemented in Go with Go APIs.
...
* [lupa](https://github.com/scoder/lupa) ⭐ 1,152 | 🐛 64 | 🌐 Python | 📅 2026-09-11 - Python bindings to LuaJIT2.
...
* [golua](https://github.com/aarzilli/golua) ⭐ 700 | 🐛 14 | 🌐 C | 📅 2025-02-17 - Golang bindings to the Lua C API.
...
* [Lua](http://www.lua.org/download.html) - Lua's original ANSI C interpreter.
  * [Lua Repo](https://github.com/lua/lua) ⭐ 10,320 | 🐛 0 | 🌐 C | 📅 2026-09-17 - The official Lua repo, as seen by the Lua team, mirrored to GitHub.
...
* [luastatic](https://github.com/ers35/luastatic) ⭐ 877 | 🐛 10 | 🌐 Lua | 📅 2023-10-28 - Simple tool for turning Lua programs into standalone executables.
* [Lake](https://github.com/stevedonovan/Lake) ⭐ 143 | 🐛 23 | 🌐 Lua | 📅 2015-09-24 - A build engine written in Lua, similar to Ruby's rake.
* [Luabuild](https://github.com/stevedonovan/luabuild) ⭐ 82 | 🐛 2 | 🌐 C | 📅 2015-12-21 - Highly customizable Lua 5.2 build system.
...
* [lua-mode](https://github.com/immerrr/lua-mode) ⭐ 343 | 🐛 37 | 🌐 Emacs Lisp | 📅 2025-03-10 - Emacs major mode for editing Lua.
* [vscode-lua](https://github.com/trixnz/vscode-lua) ⭐ 125 | 🐛 60 | 🌐 TypeScript | 📅 2024-03-21 - VSCode intellisense and linting.
...
* [Lua Fun](https://github.com/luafun/luafun) ⭐ 2,265 | 🐛 48 | 🌐 Lua | 📅 2026-09-10 - High-performance functional programming library designed for LuaJIT.
* [Penlight](https://github.com/stevedonovan/Penlight) ⭐ 2,128 | 🐛 45 | 🌐 Lua | 📅 2026-09-03 - Broad, heavyweight utility library, inspired by Python's standard libs. Provides the batteries that Lua doesn't.
...
* [lua-stdlib](https://github.com/lua-stdlib/lua-stdlib) ⭐ 307 | 🐛 12 | 🌐 Lua | 📅 2026-07-26 - Middle-weight standard library extension; adds some useful data structures, utility functions, and basic functional stuff.
* [Microlight](https://github.com/stevedonovan/Microlight) ⭐ 191 | 🐛 10 | 🌐 Lua | 📅 2022-07-05 - A little library of useful Lua functions; the 'extra light' version of Penlight.
...
* [lume](https://github.com/rxi/lume/) ⭐ 1,244 | 🐛 22 | 🌐 Lua | 📅 2023-11-19 - Utility belt library geared toward game development.
...
* LÖVE
  * [awesome-love2d](https://github.com/love2d-community/awesome-love2d) ⭐ 4,500 | 🐛 0 | 🌐 PowerShell | 📅 2026-08-23 - A list like this one, but focused on game dev and the LÖVE platform.
...
* Tweening
  ...
  * [flux](https://github.com/rxi/flux) ⭐ 485 | 🐛 10 | 🌐 Lua | 📅 2020-12-16 - A fast, lightweight tweening library for Lua with easing functions and the ability to group tweens together.
* Examples
  ...
  * [Mari0](https://github.com/Stabyourself/mari0) ⭐ 774 | 🐛 13 | 🌐 Lua | 📅 2023-09-15 - Fusion of Mario and Portal, made with LÖVE. See also its [wikipedia entry](https://en.wikipedia.org/wiki/Mari0).
...
* [lua-log](https://github.com/moteus/lua-log) ⭐ 116 | 🐛 2 | 🌐 Lua | 📅 2018-09-19 - Asynchronous logging library with pluggable writers for file system, network, ZeroMQ, and more.
* [luasyslog](https://luarocks.org/modules/luarocks/luasyslog) - Log to syslog, based on LuaLogging.

### Web/Networking Platforms

* [Pegasus.lua](https://github.com/EvandroLG/pegasus.lua) ⭐ 468 | 🐛 16 | 🌐 Lua | 📅 2026-03-08 - Pegasus.lua is a http server to work with web applications written in Lua language.
...
* [awesome-resty](https://github.com/bungle/awesome-resty) ⭐ 2,484 | 🐛 2 | 📅 2026-05-26 - A list like this one, but focused on OpenResty.
* Core platform
...
* Frameworks & tools
  * [Kong](https://github.com/Kong/kong) ⭐ 44,153 | 🐛 200 | 🌐 Lua | 📅 2026-09-07 - Microservice & API Management Layer.
...
* Coroutine-based multitasking:
  * [ConcurrentLua](https://github.com/lefcha/concurrentlua) ⭐ 164 | 🐛 0 | 🌐 Lua | 📅 2014-11-22 - Implements an Erlang-style message-passing concurrency model.
...
* [middleclass](https://github.com/kikito/middleclass) ⭐ 1,925 | 🐛 1 | 🌐 Lua | 📅 2025-11-03 - Simple but robust OOP library with inheritance, methods, metamethods, class variables and mixins.
...
* [luaposix](https://github.com/luaposix/luaposix) ⭐ 594 | 🐛 34 | 🌐 C | 📅 2026-07-20 - Bindings for POSIX APIs, including curses.
...
* [LuaDate](https://github.com/Tieske/date) ⭐ 277 | 🐛 1 | 🌐 Lua | 📅 2026-02-17 - Date and time module with parsing, formatting, addition/subtraction, localization, and ISO 8601 support.
* [cron.lua](https://github.com/kikito/cron.lua) ⭐ 189 | 🐛 1 | 🌐 Lua | 📅 2023-09-10 - Time-related functions for Lua, inspired by JavaScript's setTimeout and setInterval.
...
* [lyaml](https://github.com/gvvaughan/lyaml) ⭐ 229 | 🐛 19 | 🌐 Lua | 📅 2026-07-25 - YAML encoding/decoding via binding to LibYAML.
...
* JSON
  * [json.lua](https://github.com/rxi/json.lua) ⭐ 2,192 | 🐛 28 | 🌐 Lua | 📅 2023-11-28 - A fast and tiny JSON library in pure Lua.
  * [lua-cjson](https://github.com/mpx/lua-cjson/) ⭐ 996 | 🐛 61 | 🌐 C | 📅 2024-06-19 - Blazing fast JSON encoding/decoding implemented in C and exposed to Lua.
...
* LPeg
  ...
  * [lpeg\_patterns](https://github.com/daurnimator/lpeg_patterns) ⭐ 130 | 🐛 9 | 🌐 Lua | 📅 2022-05-23 - A collection of LPeg patterns.
...
* [inspect.lua](https://github.com/kikito/inspect.lua) ⭐ 1,539 | 🐛 7 | 🌐 Lua | 📅 2026-01-05 - Human-readable representation of Lua tables.
* [serpent](https://github.com/pkulchenko/serpent) ⭐ 619 | 🐛 13 | 🌐 Lua | 📅 2022-05-21 - Serializer and pretty printer.
...
* [lua-zlib](https://github.com/brimworks/lua-zlib) ⭐ 289 | 🐛 4 | 🌐 C | 📅 2026-01-04 - Simple streaming interface to zlib for gzip/gunzip.
* [lua-zip](https://github.com/brimworks/lua-zip) ⭐ 89 | 🐛 5 | 🌐 C | 📅 2022-02-03 - Lua binding to libzip. Reads and writes zip files.
...
* [LuaSocket](https://github.com/diegonehab/luasocket) ⭐ 2,026 | 🐛 103 | 🌐 HTML | 📅 2026-09-02 - Networking extension which provides a socket API for TCP and UDP, and implements HTTP, FTP, and SMTP.
...
* [lua-websockets](https://github.com/lipp/lua-websockets) ⭐ 419 | 🐛 44 | 🌐 Lua | 📅 2026-07-29 - WebSocket client and server modules. Webserver-agnostic, implemented in Lua on top of LuaSocket.
* [lua-cURLv3](https://github.com/Lua-cURL/Lua-cURLv3) ⭐ 293 | 🐛 19 | 🌐 C | 📅 2023-07-03 - Lua binding to libcurl.
...
* [luacheck](https://github.com/mpeterv/luacheck) ⭐ 2,051 | 🐛 46 | 🌐 Lua | 📅 2022-12-18 - Simple static analyzer which detects accidental globals and undefined or shadowed locals.
...
* [KoReader](https://github.com/koreader/koreader) ⭐ 29,792 | 🐛 1,344 | 🌐 Lua | 📅 2026-09-19 - An ebook reader application supports PDF, DJVU, EPUB, FB2 and much more, running on Kindle, Kobo, PocketBook and Android devices.
...
* [Lua Missions](https://github.com/kikito/lua_missions) ⭐ 396 | 🐛 4 | 🌐 Lua | 📅 2024-06-08 - A series of 'Missions' to work through which are designed to teach aspects of Lua along the way.
