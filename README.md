...
Inspired by the lists [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,690 | 🐛 106 | 📅 2026-09-02, [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,666 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02, and [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,799 | 🐛 25 | 📅 2026-09-02.
...
* [lupa](https://github.com/scoder/lupa) ⭐ 1,151 | 🐛 63 | 🌐 Python | 📅 2026-09-11 - Python bindings to LuaJIT2.
...
* [Lua](http://www.lua.org/download.html) - Lua's original ANSI C interpreter.
  * [Lua Repo](https://github.com/lua/lua) ⭐ 10,297 | 🐛 0 | 🌐 C | 📅 2026-08-28 - The official Lua repo, as seen by the Lua team, mirrored to GitHub.
...
* Frameworks & tools
  * [Kong](https://github.com/Kong/kong) ⭐ 44,126 | 🐛 200 | 🌐 Lua | 📅 2026-09-07 - Microservice & API Management Layer.
...
* JSON
  * [json.lua](https://github.com/rxi/json.lua) ⭐ 2,191 | 🐛 28 | 🌐 Lua | 📅 2023-11-28 - A fast and tiny JSON library in pure Lua.
...
* [KoReader](https://github.com/koreader/koreader) ⭐ 29,688 | 🐛 1,342 | 🌐 Lua | 📅 2026-09-13 - An ebook reader application supports PDF, DJVU, EPUB, FB2 and much more, running on Kindle, Kobo, PocketBook and Android devices.
