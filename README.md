...
Inspired by the lists [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,349 | 🐛 105 | 📅 2026-09-02, [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,643 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02, and [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,685 | 🐛 26 | 📅 2026-09-02.
...
* [MoonSharp](https://github.com/xanathar/moonsharp) ⭐ 1,615 | 🐛 112 | 🌐 C# | 📅 2026-08-04 - A Lua interpreter written entirely in C# for the .NET, Mono and Unity platforms.
...
* [Lua](http://www.lua.org/download.html) - Lua's original ANSI C interpreter.
  * [Lua Repo](https://github.com/lua/lua) ⭐ 10,279 | 🐛 0 | 🌐 C | 📅 2026-08-28 - The official Lua repo, as seen by the Lua team, mirrored to GitHub.
...
* [lua-mode](https://github.com/immerrr/lua-mode) ⭐ 345 | 🐛 37 | 🌐 Emacs Lisp | 📅 2025-03-10 - Emacs major mode for editing Lua.
...
* [Lua Fun](https://github.com/luafun/luafun) ⭐ 2,263 | 🐛 47 | 🌐 Lua | 📅 2025-04-15 - High-performance functional programming library designed for LuaJIT.
* [Penlight](https://github.com/stevedonovan/Penlight) ⭐ 2,126 | 🐛 44 | 🌐 Lua | 📅 2026-08-15 - Broad, heavyweight utility library, inspired by Python's standard libs. Provides the batteries that Lua doesn't.
...
* [lua-stdlib](https://github.com/lua-stdlib/lua-stdlib) ⭐ 306 | 🐛 12 | 🌐 Lua | 📅 2026-07-26 - Middle-weight standard library extension; adds some useful data structures, utility functions, and basic functional stuff.
...
* LÖVE
  * [awesome-love2d](https://github.com/love2d-community/awesome-love2d) ⭐ 4,487 | 🐛 0 | 🌐 PowerShell | 📅 2026-08-23 - A list like this one, but focused on game dev and the LÖVE platform.
...
* Examples
  ...
  * [Mari0](https://github.com/Stabyourself/mari0) ⭐ 772 | 🐛 13 | 🌐 Lua | 📅 2023-09-15 - Fusion of Mario and Portal, made with LÖVE. See also its [wikipedia entry](https://en.wikipedia.org/wiki/Mari0).
...
* [lua-log](https://github.com/moteus/lua-log) ⭐ 115 | 🐛 2 | 🌐 Lua | 📅 2018-09-19 - Asynchronous logging library with pluggable writers for file system, network, ZeroMQ, and more.
...
* Frameworks & tools
  * [Kong](https://github.com/Kong/kong) ⭐ 44,077 | 🐛 193 | 🌐 Lua | 📅 2026-08-16 - Microservice & API Management Layer.
...
* Coroutine-based multitasking:
  * [ConcurrentLua](https://github.com/lefcha/concurrentlua) ⭐ 163 | 🐛 0 | 🌐 Lua | 📅 2014-11-22 - Implements an Erlang-style message-passing concurrency model.
...
* [middleclass](https://github.com/kikito/middleclass) ⭐ 1,921 | 🐛 1 | 🌐 Lua | 📅 2025-11-03 - Simple but robust OOP library with inheritance, methods, metamethods, class variables and mixins.
...
* LPeg
  ...
  * [lpeg\_patterns](https://github.com/daurnimator/lpeg_patterns) ⭐ 131 | 🐛 9 | 🌐 Lua | 📅 2022-05-23 - A collection of LPeg patterns.
...
* [say](https://github.com/Olivine-Labs/say) ⭐ 52 | 🐛 0 | 🌐 Lua | 📅 2026-08-15 - Simple string key-value store for i18n.
...
* [LuaSocket](https://github.com/diegonehab/luasocket) ⭐ 2,022 | 🐛 104 | 🌐 HTML | 📅 2026-09-02 - Networking extension which provides a socket API for TCP and UDP, and implements HTTP, FTP, and SMTP.
...
* [pgmoon](https://github.com/leafo/pgmoon) ⭐ 435 | 🐛 22 | 🌐 MoonScript | 📅 2026-08-11 - Lua PostgreSQL driver for OpenResty, LuaSocket, and cqueues.
...
* [KoReader](https://github.com/koreader/koreader) ⭐ 29,437 | 🐛 1,323 | 🌐 Lua | 📅 2026-09-02 - An ebook reader application supports PDF, DJVU, EPUB, FB2 and much more, running on Kindle, Kobo, PocketBook and Android devices.
